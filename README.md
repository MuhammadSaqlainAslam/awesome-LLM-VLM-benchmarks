...
## 🚀 Today's Daily 8 (April 21, 2026)

| Paper | Modality | Benchmarks | Datasets | Metrics | Notes | Links |
| :--- | :---: | :--- | :--- | :--- | :--- | :--- |
| **MedProbeBench** | LLM | MedProbeBench / MedProbe-Eval | 1,200+ Rubric Criteria / 5,130+ Atomic Claims / 17 LLMs + Deep Research Agents | Rubric Pass Rate / Atomic Claim Coverage / Evidence Integration Score | [Notes](./survey/2026-04-20-medprobebench.md) | [arXiv](https://arxiv.org/abs/2604.18418) |
| **AJ-Bench** | LLM | AJ-Bench | 155 Tasks / 516 Annotated Trajectories / 3 Domains (Search / Data Systems / GUI) | Verification Accuracy per Dimension / Gain over LLM-as-a-Judge | [Notes](./survey/2026-04-20-aj-bench.md) | [arXiv](https://arxiv.org/abs/2604.18240) |
| **WebCompass** | LLM | WebCompass | 15 Gen Domains / 16 Editing Op Types / 11 Repair Defect Types / Easy–Hard Levels | Browser Execution Pass Rate / Aesthetic Score / Framework Success Rate | [Notes](./survey/2026-04-20-webcompass.md) | [arXiv](https://arxiv.org/abs/2604.18224) |
| **TPS-CalcBench** | LLM | TPS-CalcBench | 420 Core + 810 Pre-Gating Items / 8 Categories / 4 Difficulty Levels / 13 Models | KPI Score (12.6–87.9%) / Formula Selection Accuracy / Intervention Delta | [Notes](./survey/2026-04-20-tps-calcbench.md) | [arXiv](https://arxiv.org/abs/2604.17966) |
| **TeleEmbedBench** | LLM | TeleEmbedBench | 9,000 Q-Chunk Pairs / 3 Corpora (O-RAN / 3GPP / srsRAN) / 8 Embedding Models | Retrieval Accuracy / Cross-Domain Robustness / Code vs. Spec Gap | [Notes](./survey/2026-04-20-teleembedbench.md) | [arXiv](https://arxiv.org/abs/2604.17778) |
| **VisualTextTrap** | VLM | VisualTextTrap | 6,057 Human-Validated Samples / 88 Fine-Grained Attributes / 5-Level Intensity Scale | Hallucination Rate by Intensity / VQA Accuracy under Text-Visual Conflict | [Notes](./survey/2026-04-19-visualtexttrap.md) | [arXiv](https://arxiv.org/abs/2604.17375) |
| **KnowledgeBerg** | LLM | KnowledgeBerg | 4,800 MCQ / 1,183 Enumeration Seeds / 10 Domains / 17 Languages | Universe Enumeration F1 (5.26–36.88) / Compositional Reasoning Acc (16–44%) | [Notes](./survey/2026-04-19-knowledgeberg.md) | [arXiv](https://arxiv.org/abs/2604.17621) |
| **Terminal Wrench** | LLM | Terminal Wrench | 331 Reward-Hackable Envs / 3,632 Exploit Trajectories / 3 Frontier Models | Exploit Success Rate / Monitor AUC (0.97 → 0.92 w/o CoT) | [Notes](./survey/2026-04-19-terminal-wrench.md) | [arXiv](https://arxiv.org/abs/2604.17596) |
...
| **DR³-Eval** | Deep Research Agent Evaluation (5-Dimensional) | Static Sandbox Corpora / Authentic User Materials / Supportive + Distractor + Noise Documents | Information Recall / Factual Accuracy / Citation Coverage / Instruction Following / Depth Quality | **Critical failure modes in retrieval robustness and hallucination control under distractor noise** | [Notes](./survey/2026-04-16-dr3-eval.md) | [arXiv](https://arxiv.org/abs/2604.14683) |
| **ProVoice-Bench** | Proactive Voice Agent Evaluation (First Benchmark) | 1,182 Samples / 4 Proactivity Task Types / Multi-Stage Synthesis Pipeline | Proactive Intervention Accuracy / Over-Triggering Rate / Contextual Reasoning Quality | **Significant over-triggering and reasoning gaps in all current multimodal LLMs** | [Notes](./survey/2026-04-16-provoice-bench.md) | [arXiv](https://arxiv.org/abs/2604.15037) |
| **QuantSightBench** | LLM Quantitative Forecasting with Prediction Intervals | Multi-Domain Numerical Forecasting Qs / 11 Frontier + Open-Weight Models | Empirical Coverage Rate / Interval Sharpness / Calibration Error | **79.1% coverage (Gemini 3.1 Pro); no model reaches 90% target** | [Notes](./survey/2026-04-17-quantsightbench.md) | [arXiv](https://arxiv.org/abs/2604.15859) |
| **KWBench** | Unprompted Problem Recognition in Knowledge Work | 223 Expert-Curated Tasks / M&A + Fraud + Pharma + Contract / 16 LLMs | Problem Recognition Accuracy / Routing Coverage | **27.9% best single model; 50.7% with 8-model ensemble** | [Notes](./survey/2026-04-17-kwbench.md) | [arXiv](https://arxiv.org/abs/2604.15760) |
| **PRL-Bench** | Frontier Physics Research Workflows (End-to-End) | 100 PRL Papers (Aug 2025+) / 5 Subfields / Expert-Validated | End-to-End Research Score / Subfield Accuracy | **Best overall score < 50/100 across all frontier models** | [Notes](./survey/2026-04-16-prl-bench.md) | [arXiv](https://arxiv.org/abs/2604.15411) |
| **DPrivBench** | Differential Privacy Reasoning Verification | Textbook → Advanced DP Mechanisms / Multi-Difficulty / Frontier LLMs | DP Verification Accuracy / Textbook vs. Advanced Gap | **All models struggle on advanced algorithms; frontier models handle textbook DP well** | [Notes](./survey/2026-04-17-dprivbench.md) | [arXiv](https://arxiv.org/abs/2604.15851) |
| **KnowledgeBerg** | Systematic Knowledge Coverage + Compositional Reasoning (Width & Depth) | 4,800 MCQ / 1,183 Enumeration Seeds / 10 Domains / 17 Languages | Universe Enumeration F1 / Compositional Reasoning Accuracy | **Enumeration F1: 5.26–36.88; Compositional Acc: 16.00–44.19 across all models** | [Notes](./survey/2026-04-19-knowledgeberg.md) | [arXiv](https://arxiv.org/abs/2604.17621) |
| **TPS-CalcBench** | Engineering Calculation Competence (Hypersonic TPS, Safety-Critical) | 420 Core + 810 Pre-Gating Items / 8 Categories / 4 Difficulty Levels / 13 Models | KPI Score / Formula Selection Accuracy / Intervention Delta | **KPI range 12.6%–87.9%; hidden formula-selection defects in mid-performing models** | [Notes](./survey/2026-04-20-tps-calcbench.md) | [arXiv](https://arxiv.org/abs/2604.17966) |
| **MedProbeBench** | Expert-Level Medical Guideline Generation (Deep Evidence Integration) | 1,200+ Rubric Criteria / 5,130+ Atomic Claims / 17 LLMs + Deep Research Agents | Rubric Pass Rate / Atomic Claim Coverage / Evidence Integration Score | **Critical gaps in evidence integration across all 17 systems; no model reaches expert level** | [Notes](./survey/2026-04-20-medprobebench.md) | [arXiv](https://arxiv.org/abs/2604.18418) |
...
| **QuantCode-Bench** | Domain-Specific Code Generation (Algorithmic Trading) | 400 Tasks (Reddit + TradingView + StackExchange + Synthetic) / Single-Attempt + Multi-Turn Modes | Syntax / Backtest Execution / Trade Presence / Semantic Alignment (LLM Judge) | **Primary failures: trading logic operationalization and API misuse, not syntax** | [Notes](./survey/2026-04-16-quantcode-bench.md) | [arXiv](https://arxiv.org/abs/2604.15151) |
| **FedGUI** | Federated GUI Agent Evaluation (First Benchmark) | 6 Datasets / Mobile + Web + Desktop / 4 Heterogeneity Types (Cross-Platform/Device/OS/Source) | Task Success Rate / Federated Accuracy per Heterogeneity Type | **Cross-platform collaboration improves performance; platform + OS most influential factors (ACL 2026)** | [Notes](./survey/2026-04-16-fedgui.md) | [arXiv](https://arxiv.org/abs/2604.14956) |
| **HWE-Bench** | Hardware Bug Repair Agent (Repository-Level, First Benchmark) | 417 Real Bug-Fix PRs / 6 Open-Source Hardware Projects / Verilog + SystemVerilog + Chisel / 7 LLMs + 4 Frameworks | Task Resolution Rate / Complexity-Stratified Performance | **70.7% overall; >90% on simple RISC-V; <65% on complex SoC; fault localization is top bottleneck** | [Notes](./survey/2026-04-16-hwe-bench.md) | [arXiv](https://arxiv.org/abs/2604.14709) |
| **GTA-2** | General Tool Agent — Atomic Tool-Use to Open-Ended Workflows | GTA-Atomic (Single-Step) + GTA-Workflow (Long-Horizon) / Real Tools / Frontier Models | Task Success Rate / Workflow Completion Rate | **<50% atomic; only 14.39% workflow completion for top models** | [Notes](./survey/2026-04-17-gta-2.md) | [arXiv](https://arxiv.org/abs/2604.15715) |
| **HarmfulSkillBench** | Harmful Skills in Agent Ecosystems (Large-Scale Measurement) | 98,440 Skills Audited / 200 Harmful Skills / 20 Categories / 6 LLMs / 4 Conditions | Harm Score (0–1) / Refusal Rate / Harm Score Delta | **Harm score 0.27 → 0.47 with skill installed; 0.76 with implicit harmful intent** | [Notes](./survey/2026-04-16-harmfulskillbench.md) | [arXiv](https://arxiv.org/abs/2604.15415) |
| **MemEvoBench** | Memory MisEvolution Safety in Long-Horizon LLM Agents | QA: 7 Domains / 36 Risk Categories + Workflow: 20 Safety-Focused Agent Envs | Safety Degradation Rate / Defense Efficacy | **Substantial safety degradation across all LLMs; static prompt defenses insufficient** | [Notes](./survey/2026-04-17-memevobench.md) | [arXiv](https://arxiv.org/abs/2604.15774) |
| **AJ-Bench** | Agent-as-a-Judge for Environment-Aware Verification (ACL 2026) | 155 Tasks / 516 Annotated Trajectories / 3 Domains (Search / Data Systems / GUI) | Verification Accuracy per Dimension / Performance Gain over LLM-as-a-Judge | **Consistent gains over LLM-as-a-Judge baselines; process verification hardest dimension** | [Notes](./survey/2026-04-20-aj-bench.md) | [arXiv](https://arxiv.org/abs/2604.18240) |
| **WebCompass** | Multimodal Web Coding Evaluation (Generation / Editing / Repair) | 15 Gen Domains / 16 Editing Op Types / 11 Repair Defect Types / Text+Image+Video Modalities | Browser Execution Pass Rate / Aesthetic Score / Framework Success Rate | **Closed-source beats open-source; aesthetics is primary bottleneck; Vue hardest framework** | [Notes](./survey/2026-04-20-webcompass.md) | [arXiv](https://arxiv.org/abs/2604.18224) |
| **Terminal Wrench** | Reward Hacking Dataset — Terminal Agent Environments | 331 Reward-Hackable Envs / 3,632 Exploit + 2,352 Baseline Trajectories / 3 Frontier Models | Exploit Success Rate / Monitor AUC (with/without CoT) | **Monitor AUC drops 0.97→0.92 when CoT traces removed; exploits span output spoofing to binary hijacking** | [Notes](./survey/2026-04-19-terminal-wrench.md) | [arXiv](https://arxiv.org/abs/2604.17596) |
| **TeleEmbedBench** | Telecom RAG Embedding Evaluation (O-RAN / 3GPP / srsRAN) | 9,000 Q-Chunk Pairs / 3 Chunk Sizes / 3 Corpora / 8 Embedding Models | Retrieval Accuracy / Cross-Domain Robustness / Code vs. Spec Performance Gap | **LLM-based embedders (Qwen3, EmbeddingGemma) significantly outperform sentence-transformers on all corpora** | [Notes](./survey/2026-04-20-teleembedbench.md) | [arXiv](https://arxiv.org/abs/2604.17778) |
...
| **MirrorBench** | MLLM Self-Centric Intelligence (Mirror Self-Recognition) | Tiered Tasks: Basic Visual Perception → High-Level Self-Representation / Simulation-Based / Human Baseline | Tier-Level Accuracy / Self-Recognition Rate | **All leading MLLMs substantially below human even at basic Tier 1; critical gap for embodied AI** | [Notes](./survey/2026-04-16-mirrorbench.md) | [arXiv](https://arxiv.org/abs/2604.14785) |
| **ADAPT** | Embodied Planning under Dynamic Affordance Constraints | DynAfford / Household Planning Scenarios / LoRA VLM vs. GPT-4o Affordance Backend | Task Success Rate / Affordance Inference Accuracy | **Domain-adapted LoRA-finetuned VLM outperforms GPT-4o as affordance inference backend** | [Notes](./survey/2026-04-16-adapt-dynafford.md) | [arXiv](https://arxiv.org/abs/2604.14902) |
| **CrossMath** | VLM Modality Gap — Visual vs. Text Reasoning Isolation | Same Math Problems in 3 Formats (Text-only / Image-only / Image+Text) / Leading VLMs | Accuracy per Modality / Modality Gap (Text − Image Acc) | **VLMs degrade when visual data added; reasoning primarily in text space even with images** | [Notes](./survey/2026-04-17-crossmath.md) | [arXiv](https://arxiv.org/abs/2604.16256) |
| **VisualTextTrap** | Text Overlay-Induced Hallucination in VLMs (First Comprehensive Benchmark) | 6,057 Human-Validated Samples / 88 Fine-Grained Attributes / 5-Level Intensity Scale (L1–L5) | Hallucination Rate by Intensity / VQA Accuracy under Text-Visual Conflict | **All VLMs systematically hallucinate under conflicting text overlays; VTHM-MoE reduces failures** | [Notes](./survey/2026-04-19-visualtexttrap.md) | [arXiv](https://arxiv.org/abs/2604.17375) |
...
| **MCSC-Bench** | Multimodal Context-to-Script Creation (End-to-End Video Production) | 11,000+ Annotated Videos / Material Selection + Narrative Planning + Script Gen / In-Domain + OOD | Script Quality / Shot Alignment / Voiceover Coherence / Downstream Video Gen Success | **8B model trained on MCSC-Bench exceeds Gemini-2.5-Pro; long-context structure-aware reasoning is bottleneck** | [Notes](./survey/2026-04-16-mcsc-bench.md) | [arXiv](https://arxiv.org/abs/2604.15127) |
