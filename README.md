...
## 🚀 Today's Daily 8 (April 17, 2026)

| Paper | Modality | Benchmarks | Datasets | Metrics | Notes | Links |
| :--- | :---: | :--- | :--- | :--- | :--- | :--- |
| **QuantCode-Bench** | LLM | QuantCode-Bench | 400 Tasks (Reddit + TradingView + StackExchange + Synthetic) | Syntax / Backtest Execution / Semantic Alignment (LLM Judge) | [Notes](./survey/2026-04-16-quantcode-bench.md) | [arXiv](https://arxiv.org/abs/2604.15151) |
| **FedGUI** | LLM | FedGUI | 6 Curated Datasets / Mobile + Web + Desktop / 4 Heterogeneity Types | Task Success Rate / Cross-Platform Federated Accuracy | [Notes](./survey/2026-04-16-fedgui.md) | [arXiv](https://arxiv.org/abs/2604.14956) |
| **ADAPT** | VLM | DynAfford | Embodied Planning Tasks / Dynamic Affordance Constraints / LoRA VLM vs. GPT-4o | Task Success Rate / Affordance Inference Accuracy | [Notes](./survey/2026-04-16-adapt-dynafford.md) | [arXiv](https://arxiv.org/abs/2604.14902) |
| **HWE-Bench** | LLM | HWE-Bench | 417 Real Hardware Bug-Fix PRs / 6 Open-Source Projects / 7 LLMs / 4 Agent Frameworks | Task Resolution Rate / Project-Level Stratified Performance | [Notes](./survey/2026-04-16-hwe-bench.md) | [arXiv](https://arxiv.org/abs/2604.14709) |
| **MirrorBench** | VLM | MirrorBench | Tiered Mirror Self-Recognition Tasks / Basic Perception → High-Level Self-Representation | Tier-Level Accuracy / Self-Recognition Rate vs. Human Baseline | [Notes](./survey/2026-04-16-mirrorbench.md) | [arXiv](https://arxiv.org/abs/2604.14785) |
| **DR³-Eval** | LLM | DR³-Eval | Static Sandbox Corpora / Real User Materials / Supportive + Distractor + Noise Docs | Information Recall / Factual Accuracy / Citation Coverage / Instruction Following / Depth Quality | [Notes](./survey/2026-04-16-dr3-eval.md) | [arXiv](https://arxiv.org/abs/2604.14683) |
| **ProVoice-Bench** | LLM | ProVoice-Bench | 1,182 Samples / 4 Proactivity Task Types / Multi-Stage Synthesis Pipeline | Proactive Intervention Accuracy / Over-Triggering Rate | [Notes](./survey/2026-04-16-provoice-bench.md) | [arXiv](https://arxiv.org/abs/2604.15037) |
| **MCSC-Bench** | VLM | MCSC-Bench | 11,000+ Annotated Videos / Material Selection + Narrative Planning + Script Gen / In-Domain + OOD | Script Quality / Shot Alignment / Downstream Video Gen Success | [Notes](./survey/2026-04-16-mcsc-bench.md) | [arXiv](https://arxiv.org/abs/2604.15127) |
